 ...
 * ConcurrentHashMap to permit non-synchronized reads.  May be configured to
...
//    }
    ...
    static class Segment<T,A> {
        ...
        private synchronized void remove(Entry<T>[] table, int hash, Entry<T> e) {
        ...
        private synchronized Entry<T>[] rehash() {
